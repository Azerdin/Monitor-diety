...
namespace ProjektNutrition.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var product = db.Product.Include(p => p.AspNetUsers).Include(p => p.Category);
        ...
        public ActionResult Create([Bind(Include = "id,Users_id,name,caloric,protein,carb,fat,weight,Category_id")] Product product)
        {
